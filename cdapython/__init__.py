...
from cdapython.factories.unique_terms.unique_terms_endpoint import UniqueTerms
...
def console_print(*args, **kwargs) -> None:
    ...
    """
    print("ran cdapython/__init__.py.stupid console_print")
    if "file" in kwargs:
        print(*args)
    else:
...
def __repr__() -> str:
    print("ran cdapython/__init__.py.stupid __repr__")
    return __version__
