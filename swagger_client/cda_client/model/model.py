...
class Model(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'date': (str,),  # noqa: E501
            'model': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            model ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
