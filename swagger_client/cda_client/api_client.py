...
from cda_client import rest
from cda_client.configuration import Configuration
from cda_client.exceptions import ApiTypeError, ApiValueError, ApiException
from cda_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.17.2023/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MetaApi()
        api_instance.all_release_notes  # this is an instance of the class Endpoint
        api_instance.all_release_notes()  # this invokes api_instance.all_release_notes.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.all_release_notes.callable or self.callable in this class
