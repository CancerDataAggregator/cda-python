    ...
    "result": [
        {
            ...
            "subject_identifier_system": [
                {
                    "subject_identifier_system": "CDS",
                    "count": 15818
                },
                {
                    "subject_identifier_system": "GDC",
                    "count": 41383
                },
                {
                    "subject_identifier_system": "IDC",
                    "count": 5901
                },
                {
                    "subject_identifier_system": "PDC",
                    "count": 1198
                }
            ],
            "sex": [
            ...
            "race": [
                ...
                {
                    "race": "White;Native Hawaiian or Other Pacific Islander",
                    "count": 1
                },
                {
                    "race": "null",
            ...
            "cause_of_death": [
                ...
                {
                    "cause_of_death": "Cardiovascular Disorder, NOS",
                    "count": 4
                },
                {
                ...
                {
                    "cause_of_death": "Surgical Complications",
                    "count": 3
                },
                {
                    "cause_of_death": "Toxicity",
                    "count": 2
                },
                {
...
@patch("cda_client.api_client.ApiClient.call_api", create=True, return_value=fake_result)
def test_count(_):
    q1 = Q('sex = "male"')
    q = q1
    print(q)
