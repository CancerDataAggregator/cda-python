...
result = [{'total': 65, 'files': 45342, 'system': [{'system': 'GDC', 'count': 65}, {'system': 'PDC', 'count': 65}, {'system': 'IDC', 'count': 65}], 'sex': [{'sex': 'male', 'count': 47}, {'sex': 'female', 'count': 18}], 'race': [{'race': 'white', 'count': 38}, {'race': 'not reported', 'count': 26}, {'race': 'asian', 'count': 1}], 'ethnicity': [{'ethnicity': 'not hispanic or latino', 'count': 26}, {'ethnicity': 'not reported', 'count': 35}, {'ethnicity': 'hispanic or latino', 'count': 4}], 'cause_of_death': [{'cause_of_death': 'Not Reported', 'count': 63}, {'cause_of_death': 'Cancer Related', 'count': 2}]}]
