...
print(subject.file.count.run(limit=500, host=host, async_call=True)[0])
...
print(rs.file.count.run(limit=500, host=host, async_call=True)[0])
...
print(specimen.file.count.run(limit=500, host=host, async_call=True)[0])
...
print(file_count.run(limit=500, host=host, async_call=True)[0])
